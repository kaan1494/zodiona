...
class _TarotFlipCardState extends State<_TarotFlipCard>
  ...
  void _showCardDetail(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (_) => _CardDetailSheet(cardData: widget.cardData),
    );
  }
...
class _CardDetailSheet extends StatelessWidget {
  const _CardDetailSheet({required this.cardData});
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          ...
          colors: [Color(0xFF1A1050), Color(0xFF0D0830)],
        ),
        border: Border.all(
          color: const Color(0xFFF2D9A6).withValues(alpha: 0.3),
        ),
      ),
      child: Column(
        ...
        children: [
          ...
          ClipRRect(
            borderRadius: BorderRadius.circular(12),
            child: Image.asset(cardData.asset, height: 160, fit: BoxFit.cover),
          ),
          const SizedBox(height: 14),
          Text(
            cardData.name,
