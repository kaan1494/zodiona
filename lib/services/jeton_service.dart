...
class JetonService {
  ...
  static const String _androidRewardedAdUnitId =
      'ca-app-pub-1434103712612878/7294180040';
  ...
  // false → gerçek reklamlar gösterilir.
  ...
  /// Jeton sistemiyle ilgisizdir; çağıran ne yapacağına kendisi karar verir.
  ...
  static const List<JetonPaketi> paketler = [
    JetonPaketi(jeton: 10, fiyatTL: 47.99),
    JetonPaketi(jeton: 25, fiyatTL: 95.99),
    JetonPaketi(jeton: 50, fiyatTL: 179.99),
    JetonPaketi(jeton: 100, fiyatTL: 299.99),
    JetonPaketi(jeton: 250, fiyatTL: 599.99),
  ];
}
...
class JetonPaketi {
  ...
  /// Fiyatı Türkçe formatında gösterir (örn. 114,99 ₺).
  String get fiyatGoster {
    final str = fiyatTL.toStringAsFixed(2).replaceAll('.', ',');
    return '$str ₺';
  }
  ...
  int get tasarrufYuzdesi {
    const double bazFiyat = 47.99 / 10;
